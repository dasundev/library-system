...
<div class="container-lg mt-4">
    ...
    <form action="process.php?update=true&memberID=<?= $row[0] ?>" method="post">
    <div class="row">
        
            <div class="col-lg-5 mb-3">
                <label for="memberID" class="form-label">Member ID</label>
                <input id="memberID" name="member_id" type="text" class="form-control"  value="<?= $row[0] ?>" pattern="M\d{3}" required>
            </div>
            <div class="col-lg-5 mb-3">
                <label for="firstName" class="form-label">First Name</label>
                <input id="firstName" name="first_name" type="text" class="form-control"  value="<?= $row[1] ?>" required>
            </div>
            <div class="col-lg-5 mb-3">
                <label for="lastName" class="form-label">Last Name</label>
                <input id="lastName" name="last_name" type="text" class="form-control" value="<?= $row[2] ?>" required>
            </div>
            <div class="col-lg-5 mb-3">
                <label for="bday" class="form-label">Birthday</label>
                <input id="bday" name="birthday" type="date" class="form-control" value="<?= $row[3] ?>" required>
            </div>
            <div class="col-lg-5 mb-3">
                <label for="email" class="form-label">Email</label>
                <input id ="email" name="email" type="email" class="form-control" value="<?= $row[4] ?>" required>
            </div>
        </div>
